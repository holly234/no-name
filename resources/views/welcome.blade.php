...
<head>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box}
        ...
        .hero{position:relative;height:100vh;height:100svh;min-height:720px;padding:0;background:#171717 url('{{ asset('images/marketing/perpetual-hero-wide.png') }}') center/cover no-repeat;color:#fff}
        ...
        .hero-scroll{position:absolute;z-index:3;bottom:27px;left:50%;transform:translateX(-50%);font-size:2rem;font-weight:300}
        ...
        <div class="wrap">
            ...
            <div class="mobile-menu" x-show="menu" x-cloak
                ...
                <div class="mobile-menu-links">
                    <a href="#product" @click="menu=false">Product</a>
                    <a href="#product" @click="menu=false">Solutions</a>
                    <a href="#ai" @click="menu=false">AI teammate</a>
                    <a href="#how" @click="menu=false">How it works</a>
                    <a href="#customers" @click="menu=false">Customers</a>
                </div>
            </div>
        </div>
    </header>
    ...
    <main>
        <section class="hero">
            <div class="wrap hero-grid">
                ...
                <a class="hero-scroll" href="#product" aria-label="Scroll to the product">↓</a>
            </div>
        </section>
