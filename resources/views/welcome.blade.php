        ...
        <div class="wrap">
            ...
            <div class="mega-menu" x-show="dropdown === 'product'" x-cloak @click.outside="dropdown=null">
                <div class="mega-products">
                    <a class="mega-product" href="#product"><span class="channel-badge"><span class="platform-icon" data-platform-icon="instagram"></span></span><strong>Instagram</strong><span>Automate your Instagram conversations</span></a>
            ...
            <div class="mobile-menu" x-show="menu" x-cloak
                ...
                <div class="mobile-menu-links">
                    <div class="mobile-menu-group" x-data="{ open: true }"><button type="button" @click="open=!open" :aria-expanded="open">Product</button><div class="mobile-submenu" x-show="open" x-transition><a href="#faq" @click="menu=false"><span class="platform-icon" data-platform-icon="instagram"></span>Instagram</a><a href="#faq" @click="menu=false"><span class="platform-icon" data-platform-icon="whatsapp"></span>WhatsApp</a><a href="#faq" @click="menu=false"><span class="platform-icon" data-platform-icon="facebook"></span>Messenger</a><a href="#faq" @click="menu=false"><span class="platform-icon" data-platform-icon="telegram"></span>Telegram</a><a href="#faq" @click="menu=false"><span class="platform-icon" data-platform-icon="gmail"></span>Gmail</a></div></div>
