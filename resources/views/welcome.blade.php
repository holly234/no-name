    ...
    <style>
        ...
        *::after {
        ...
        .btn-primary {
            background: var(--blue);
            color: #fff;
            box-shadow: 0 8px 0 #132f9f
        }

        .btn-primary:hover {
            box-shadow: 0 5px 0 #132f9f
        }
        ...
        .brand-letter {
            ...
            transition: max-width .62s cubic-bezier(.76, 0, .24, 1), opacity .42s ease, transform .62s cubic-bezier(.76, 0, .24, 1)
        }
        ...
        .menu-icon-line {
            ...
            transition: top .65s cubic-bezier(.76, 0, .24, 1), transform .75s cubic-bezier(.76, 0, .24, 1), width .5s ease
        }
        ...
        .hero {
            ...
            min-height: 720px;
            padding: 0;
            background:#3b403a url('/images/marketing/perpetual-hero-wide.png') center/cover no-repeat;
            color: #fff;
        }
        ...
        .hero::before {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(90deg, rgba(0, 0, 0, .82) 0%, rgba(0, 0, 0, .51) 39%, rgba(0, 0, 0, .09) 73%), linear-gradient(0deg, rgba(0, 0, 0, .5), transparent 42%)
        }
        ...
        .hero-copy h1 {
            max-width: 790px;
            margin: 0 0 26px;
            font-size: clamp(5.6rem, 7vw, 8.25rem);
            line-height: .83;
        ...
        .hero .hero-actions .btn:not(.btn-primary) {
            display: none
        }
        ...
        .hero-blob {
            ...
            inset: 0;
            background: var(--blue);
            border-radius: 47% 53% 45% 55% / 55% 39% 61% 45%;
        ...
        .before-after>.wrap>.eyebrow::before {
            display: none
        }

        .before-after>.wrap>.eyebrow span {
            display: none
        }

        .before-after>.wrap>.eyebrow .accent-icon {
            width: 86px;
            height: 86px;
            padding: 19px;
            color: #ff684d;
        ...
        .illustration-option small {
            font-size: .64rem;
            font-weight: 700;
            color: #666
        }

        .illustration-option:nth-child(1) {
            --option-color: #2457f5
        }

        .illustration-option:nth-child(2) {
            --option-color: #ff704f
        }

        .illustration-option:nth-child(3) {
            --option-color: #7a45d1
        }

        .illustration-option:nth-child(4) {
            --option-color: #159b69
        }

        .illustration-option:nth-child(5) {
            --option-color: #111
        }

        .illustration-option:nth-child(6) {
            --option-color: #e34b7a
        }

        .illustration-option:nth-child(7) {
            --option-color: #e39a24
        }

        .illustration-option:nth-child(8) {
            --option-color: #1688b7
        }

        .illustration-option:nth-child(9) {
            --option-color: #705b3b
        }

        .illustration-option:nth-child(10) {
            --option-color: #8c4b9e
        }
        ...
        .before-after>.wrap>.illustration-picker {
            display: none
        }
        ...
        .before-after h2::after {
            content: 'Same workload. A completely different day.';
            display: block;
        ...
        .compare.before .compare-label::after {
            content: 'Before MYinboxLAB';
            font-size: .72rem
        }
        ...
        .wave {
            flex: 1;
            height: 23px;
            background: repeating-linear-gradient(90deg, #87909a 0 2px, transparent 2px 6px);
            mask-image: linear-gradient(to bottom, transparent 10%, #000 10% 90%, transparent 90%)
        }
        ...
        @media(max-width:720px) {
            ...
            .menu-open .menu-icon-line:first-child {
                top: 10px;
                transform: rotate(225deg)
            }

            .menu-open .menu-icon-line:last-child {
                top: 10px;
                transform: rotate(-225deg)
            }
            ...
            .menu-open .brand-letter:not(.brand-keep) {
                max-width: 0;
                opacity: 0;
            ...
            .menu-open .brand-keep {
                text-transform: uppercase
            }

            .menu-open .brand-letter:nth-child(10) {
                transition-delay: .04s
            }

            .menu-open .brand-letter:nth-child(9) {
                transition-delay: .1s
            }

            .menu-open .brand-letter:nth-child(8) {
                transition-delay: .16s
            }

            .menu-open .brand-letter:nth-child(7) {
                transition-delay: .22s
            }

            .menu-open .brand-letter:nth-child(6) {
                transition-delay: .28s
            }

            .menu-open .brand-letter:nth-child(5) {
                transition-delay: .34s
            }

            .menu-open .brand-letter:nth-child(4) {
                transition-delay: .4s
            }

            .menu-open .brand-letter:nth-child(3) {
                transition-delay: .46s
            }

            .menu-open .brand-letter:nth-child(2) {
            ...
            .mobile-menu.menu-sweep-enter-active {
                transition: clip-path .95s cubic-bezier(.76, 0, .24, 1)
            }

            .mobile-menu.menu-sweep-enter-start {
                clip-path: inset(0 0 100% 0)
            }

            .mobile-menu.menu-sweep-enter-end {
                clip-path: inset(0 0 0 0)
            }

            .mobile-menu.menu-sweep-leave-active {
                transition: clip-path .7s cubic-bezier(.76, 0, .24, 1)
            }

            .mobile-menu.menu-sweep-leave-start {
                clip-path: inset(0 0 0 0)
            }

            .mobile-menu.menu-sweep-leave-end {
                clip-path: inset(0 0 100% 0)
            }

            .mobile-menu-primary,
            .mobile-menu-links {
                transition: opacity .55s ease .38s, transform .7s cubic-bezier(.22, 1, .36, 1) .3s
            }

            .mobile-menu.menu-sweep-enter-start .mobile-menu-primary,
            .mobile-menu.menu-sweep-enter-start .mobile-menu-links {
                opacity: 0;
            ...
            .mobile-menu-links a[href*="login"]::after {
                display: none
            }
            ...
            .hero::before {
                background: linear-gradient(180deg, rgba(0, 0, 0, .7) 0%, rgba(0, 0, 0, .31) 52%, rgba(0, 0, 0, .54) 100%)
            }
        ...
        .mobile-menu-group>button[aria-expanded="true"]::after {
        ...
        .footer-social .platform-icon svg {
            width: 20px;
            height: 20px
        }
        ...
        .mobile-menu-links .mobile-menu-group>button,
        .mobile-menu-links .mobile-menu-direct {
            font-family: 'Bricolage Grotesque', 'DM Sans', sans-serif !important;
        ...
        .pes-nav span:first-child {
            opacity: 1
        }

        .pes-root.is-visible .pes-card {
...
<body>
    <div class="site" x-data="{ menu: false, dropdown: null, scrolled: false }" :class="{ 'menu-open': menu }">
            ...
            <div class="wrap">
                ...
                <div class="mega-menu" x-show="dropdown === 'product'" x-cloak @click.outside="dropdown=null">
                    <div class="mega-products">
                        ...
                        <a class="mega-product" href="{{ route('marketing.telegram') }}"><span class="channel-badge"><span class="platform-icon" data-platform-icon="telegram"></span></span><strong>Telegram</strong><span>Keep Telegram enquiries moving</span></a>
                        <a class="mega-product" href="{{ route('marketing.gmail') }}"><span class="channel-badge"><span class="platform-icon" data-platform-icon="gmail"></span></span><strong>Gmail</strong><span>Turn important email into action</span></a>
                    </div>
                </div>
                <div class="mega-menu" x-show="dropdown === 'solutions'" x-cloak @click.outside="dropdown=null">
                    <div class="mega-columns">
                        <div class="mega-column">
                            <div class="mega-label">BY BUSINESS TYPE</div><a href="#customers">For service businesses</a><a href="#customers">For online stores</a><a href="#customers">For growing teams</a>
                        </div>
                        <div class="mega-column">
                            <div class="mega-label">BY USE CASE</div><a href="#product">Customer support</a><a href="#ai">AI replies</a><a href="#how">Team inbox</a>
                        </div>
                    </div>
                </div>
                <div class="mega-menu" x-show="dropdown === 'resources'" x-cloak @click.outside="dropdown=null">
                    <div class="mega-columns">
                        <div class="mega-column">
                            <div class="mega-label">LEARN</div><a href="#ai">AI inbox guide</a><a href="#how">Getting started</a><a href="#product">Help centre</a>
                        </div>
                        <div class="mega-column">
                            <div class="mega-label">GET INSPIRED</div><a href="#customers">Customer stories</a><a href="#product">Product updates</a><a href="#how">Best practices</a>
                        </div>
                    </div>
                </div>
                <div class="mobile-menu" x-show="menu" x-cloak
                    ...
                    <div class="mobile-menu-links">
                        <div class="mobile-menu-group" x-data="{ open: true }"><button type="button" @click="open=!open" :aria-expanded="open">Product</button>
                            <div class="mobile-submenu" x-show="open" x-transition><a href="{{ route('marketing.instagram') }}" @click="menu=false"><span class="platform-icon" data-platform-icon="instagram"></span>Instagram</a><a href="{{ route('marketing.whatsapp') }}" @click="menu=false"><span class="platform-icon" data-platform-icon="whatsapp"></span>WhatsApp</a><a href="{{ route('marketing.facebook') }}" @click="menu=false"><span class="platform-icon" data-platform-icon="facebook"></span>Messenger</a><a href="{{ route('marketing.telegram') }}" @click="menu=false"><span class="platform-icon" data-platform-icon="telegram"></span>Telegram</a><a href="{{ route('marketing.gmail') }}" @click="menu=false"><span class="platform-icon" data-platform-icon="gmail"></span>Gmail</a></div>
                        </div>
                        <div class="mobile-menu-group" x-data="{ open: false }"><button type="button" @click="open=!open" :aria-expanded="open">Solutions</button>
                            <div class="mobile-submenu" x-show="open" x-transition><a href="#faq" @click="menu=false">Customer support</a><a href="#faq" @click="menu=false">AI replies</a><a href="#faq" @click="menu=false">Team inbox</a></div>
                        </div>
                        <div class="mobile-menu-group" x-data="{ open: false }"><button type="button" @click="open=!open" :aria-expanded="open">Agencies</button>
                            <div class="mobile-submenu" x-show="open" x-transition><a href="#faq" @click="menu=false">For growing teams</a><a href="#faq" @click="menu=false">Partner support</a></div>
                        </div>
                        <a class="mobile-menu-direct" href="#faq" @click="menu=false">Pricing</a>
                        <div class="mobile-menu-group" x-data="{ open: false }"><button type="button" @click="open=!open" :aria-expanded="open">Resources</button>
                            <div class="mobile-submenu" x-show="open" x-transition><a href="#faq" @click="menu=false">Help centre</a><a href="#faq" @click="menu=false">Getting started</a><a href="#faq" @click="menu=false">Conversation guide</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <main>
            <section class="hero">
                <div class="wrap hero-grid">
                    ...
                    <a class="hero-scroll" href="#faq" aria-label="Scroll to the FAQ"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
            ...
            <section class="before-after">
                <div class="wrap">
                    <div class="eyebrow" style="color:#159b69"><svg class="accent-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
                            <path d="M4 7h16M4 12h10M4 17h7" />
                            <path d="m17 14 3 3-3 3M20 17h-7" />
                        </svg><span>Your inbox: before &amp; after</span></div>
                    <div class="illustration-picker" aria-label="Illustration options">
                        <button class="illustration-option" type="button"><svg viewBox="0 0 24 24" fill="none">
                                <path d="M4 5.5A2.5 2.5 0 0 1 6.5 3h11A2.5 2.5 0 0 1 20 5.5v9a2.5 2.5 0 0 1-2.5 2.5h-6l-4.2 3v-3H6.5A2.5 2.5 0 0 1 4 14.5v-9Z" />
                                <path d="m8.5 11 2.1 2.1 4.9-5" />
                            </svg><small>Inbox</small></button>
                        <button class="illustration-option" type="button"><svg viewBox="0 0 24 24" fill="none">
                                <path d="M20 11.5a8 8 0 0 1-8 8 8.8 8.8 0 0 1-3.4-.7L4 20l1.2-4.2A8 8 0 1 1 20 11.5Z" />
                                <path d="M8 11h.01M12 11h.01M16 11h.01" />
                            </svg><small>Messages</small></button>
                        <button class="illustration-option" type="button"><svg viewBox="0 0 24 24" fill="none">
                                <path d="m12 3 1.8 5.2L19 10l-5.2 1.8L12 17l-1.8-5.2L5 10l5.2-1.8L12 3Z" />
                                <path d="m19 15 .7 2.3L22 18l-2.3.7L19 21l-.7-2.3L16 18l2.3-.7L19 15Z" />
                            </svg><small>Sparkles</small></button>
                        <button class="illustration-option" type="button"><svg viewBox="0 0 24 24" fill="none">
                                <path d="M4 7h16M4 12h10M4 17h7" />
                                <path d="m17 14 3 3-3 3M20 17h-7" />
                            </svg><small>Workflow</small></button>
                        <button class="illustration-option" type="button"><svg viewBox="0 0 24 24" fill="none">
                                <rect x="4" y="4" width="16" height="16" rx="3" />
                                <path d="m8 12 2.5 2.5L16 9" />
                            </svg><small>Sorted</small></button>
                        <button class="illustration-option" type="button"><svg viewBox="0 0 24 24" fill="none">
                                <path d="M7 8h10M7 12h7M7 16h4" />
                                <path d="M5 4h14a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2h-5l-2 2-2-2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Z" />
                            </svg><small>Notes</small></button>
                        <button class="illustration-option" type="button"><svg viewBox="0 0 24 24" fill="none">
                                <path d="M4 12h16M12 4v16" />
                                <path d="m16 8 4 4-4 4M8 8l-4 4 4 4" />
                            </svg><small>Before/after</small></button>
                        <button class="illustration-option" type="button"><svg viewBox="0 0 24 24" fill="none">
                                <circle cx="6" cy="12" r="2" />
                                <circle cx="18" cy="6" r="2" />
                                <circle cx="18" cy="18" r="2" />
                                <path d="m8 11 8-4M8 13l8 4" />
                            </svg><small>Connected</small></button>
                        <button class="illustration-option" type="button"><svg viewBox="0 0 24 24" fill="none">
                                <path d="M4 6h16v12H4z" />
                                <path d="m4 7 8 6 8-6" />
                            </svg><small>Email</small></button>
                        <button class="illustration-option" type="button"><svg viewBox="0 0 24 24" fill="none">
                                <circle cx="12" cy="12" r="8" />
                                <path d="M12 8v8M8 12h8" />
                            </svg><small>One place</small></button>
                    </div>
            ...
            <section class="pes-root" id="ecosystem">
                <div class="pes-pin">
                    <div class="wrap">
                        <div class="pes-grid">
                            <div>
                                <div class="eyebrow">MYinboxLAB ecosystem</div>
                                <h2 class="pes-headline display">Everything that happens after “hello.”</h2>
                                <p class="pes-sub">From the first message to the final reply, MYinboxLAB helps your team move every customer conversation forward.</p>
                            </div>
                            <div class="pes-stage">
                                <div class="pes-bubble">
                                    <p class="pes-bubble-channel">Instagram</p>
                                    <p class="pes-bubble-text">Hey, do you have this in black?</p>
                                    <p class="pes-bubble-time">10:42 AM</p>
                                </div>
                                <div class="pes-card">
                                    <p class="pes-card-label">MYinboxLAB</p>
                                    <div class="pes-channels"><span class="pes-channel-pill"><i class="platform-icon" data-platform-icon="instagram"></i>Instagram</span><span class="pes-channel-pill"><i class="platform-icon" data-platform-icon="whatsapp"></i>WhatsApp</span><span class="pes-channel-pill"><i class="platform-icon" data-platform-icon="facebook"></i>Facebook</span><span class="pes-channel-pill"><i class="platform-icon" data-platform-icon="telegram"></i>Telegram</span><span class="pes-channel-pill"><i class="platform-icon" data-platform-icon="gmail"></i>Gmail</span></div>
                                    <div class="pes-stage-list">
                                        <div class="pes-stage-block"><span class="pes-stage-num">01</span>
                                            <div>
                                                <p class="pes-stage-title">Unified inbox</p>
                                                <p class="pes-stage-copy">Every conversation arrives in one place.</p>
                                            </div>
                                        </div>
                                        <div class="pes-stage-block"><span class="pes-stage-num">02</span>
                                            <div>
                                                <p class="pes-stage-title">Understood and organised</p>
                                                <p class="pes-stage-copy">Context stays attached and buying intent stays visible.</p>
                                            </div>
                                        </div>
                                        <div class="pes-stage-block"><span class="pes-stage-num">03</span>
                                            <div>
                                                <p class="pes-stage-title">Moved to the right person</p>
                                                <p class="pes-stage-copy">Your team takes over when judgment matters.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="pes-nav"><span>Unified inbox</span><span>Conversation context</span><span>Team handover</span><span>Clear outcomes</span></div>
                    </div>
                </div>
            </section>
            ...
            <style>
                ...
                .pes-root .pes-channel-pill:first-child {
                    background: transparent;
                    border-color: #555;
                    color: #fff
                }

                .pes-root .pes-channel-pill.pes-active {
                    background: #e7ff3f;
                    border-color: #e7ff3f;
                    color: #111
                }

                .pes-root .pes-channel-pill {
                    transition: background-color .55s cubic-bezier(.22, 1, .36, 1), border-color .55s ease, color .45s ease, transform .55s cubic-bezier(.22, 1, .36, 1)
                }
                ...
                .pes-root .pes-stage-num {
                    display: none
                }

                .pes-root .pes-stage-block {
                    grid-template-columns: 1fr
                }

                .pes-root .pes-stage-title {
                    max-width: 430px;
                    font-size: 1.25rem;
                    line-height: 1.15
                }

                .pes-root .pes-stage-copy {
                    max-width: 460px;
                    margin-top: 10px;
                    line-height: 1.55
                }
                ...
                .pes-root .pes-channel-pill .platform-icon {
                    display: inline-flex;
                    width: 14px;
                    height: 14px
                }

                .pes-root .pes-stage-list {
                    position: relative;
                    height: 125px;
                    margin-top: 24px
                }
                ...
                .pes-root .pes-stage-block:first-child {
                    opacity: 1;
                    transform: none
                }
            ...
            <section class="faq" id="faq">
                <div class="wrap">
                    <div class="faq-head">
                        <span class="faq-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
                                <path d="M21 15a4 4 0 0 1-4 4H8l-5 3V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4v8Z" />
                                <path d="M9.4 9a2.7 2.7 0 1 1 4.7 1.8c-.9.7-2.1 1.2-2.1 2.7M12 16.5h.01" />
                            </svg></span>
        ...
        <section class="steps" id="how"><div class="wrap"><div class="steps-head"><div><div class="eyebrow" style="color:var(--lime)">Live in three steps</div><h2 class="display">From scattered to sorted. Fast.</h2></div><a class="btn btn-white" href="{{ $primaryUrl }}">Get started free →</a>
    </div>
    <div class="steps-grid">
        <article class="step"><span class="step-number">1</span>
            <h3>Create your workspace</h3>
            <p>Sign in with Google and tell us the basics about your business.</p>
        </article>
        <article class="step"><span class="step-number">2</span>
            <h3>Connect your channels</h3>
            <p>Bring in the accounts your customers already message every day.</p>
        </article>
        <article class="step"><span class="step-number">3</span>
            <h3>Let conversations flow</h3>
            <p>Turn on your AI teammate, watch the queue and step in whenever you want.</p>
        </article>
    </div>
    </div>
    </section>
    ...
    <section class="ai-section" id="ai">
        <div class="wrap ai-grid">
            <div class="ai-copy">
                <div class="eyebrow" style="color:var(--blue)">AI that knows its role</div>
                <h2 class="display">Helpful enough to act. Smart enough to ask.</h2>
                <p>Teach it your services, prices and policies once. It answers naturally, understands voice notes and hands sensitive decisions to your team.</p>
                <div class="checks">
                    <div class="check"><i>✓</i>Short, natural customer replies</div>
                    <div class="check"><i>✓</i>Business knowledge plus safe general knowledge</div>
                    <div class="check"><i>✓</i>Voice-note understanding</div>
                    <div class="check"><i>✓</i>Human takeover without awkward silence</div>
                </div><a class="btn btn-primary" href="{{ $primaryUrl }}">Meet your AI teammate →</a>
            </div>
            <div class="phone-demo">
                <div class="phone-top"></div>
                <div class="phone-chat">
                    <div class="bubble customer voice"><span class="play">▶</span><span class="wave"></span><small>0:12</small></div>
                    <div class="bubble ai">Yes, we can detail your Camry this Saturday.</div>
                    <div class="bubble ai">Would morning or afternoon work better?</div>
                    <div style="padding:12px 4px 2px;color:#777;font-size:.75rem">AI understood the voice note and replied naturally ✦</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="final-cta">
        <div class="wrap">
            <h2 class="display">Your customers are already talking.</h2>
            <p>Bring every conversation together and give your team room to focus on the ones that matter most.</p>
            <div class="final-actions"><a class="btn btn-dark" href="{{ $primaryUrl }}">{{ $primaryLabel }} →</a><a class="btn" href="#product">Explore the product</a></div>
        </div>
    </section> --}}
    </main>
    ...
    <footer class="footer">
        <div class="wrap">
            <div class="footer-top">
                <div>
                    <div class="footer-brand"><a class="brand" href="/">MYinboxLAB</a>
                        <p>Every customer conversation, organized. Every important reply, easier to find.</p>
                        <div class="footer-social"><a href="#" aria-label="Instagram"><span class="platform-icon" data-platform-icon="instagram"></span></a><a href="#" aria-label="WhatsApp"><span class="platform-icon" data-platform-icon="whatsapp"></span></a><a href="#" aria-label="Facebook"><span class="platform-icon" data-platform-icon="facebook"></span></a><a href="#" aria-label="Gmail"><span class="platform-icon" data-platform-icon="gmail"></span></a><a href="#" aria-label="Telegram"><span class="platform-icon" data-platform-icon="telegram"></span></a></div>
                    </div>
                    <div class="footer-links" style="margin-top:58px">
                        <div><strong>Product</strong><a href="#faq">FAQ</a><a href="#">Unified inbox</a><a href="#">AI assistant</a><a href="#">Supported channels</a></div>
                        <div><strong>Resources</strong><a href="#faq">Help centre</a><a href="#faq">Getting started</a><a href="#faq">Conversation guide</a><a href="#faq">Updates</a></div>
                        <div><strong>MYinboxLAB</strong><a href="#">Our story</a><a href="#">How it works</a><a href="#">Security</a><a href="#">Contact</a></div>
                        <div><strong>Workspace</strong>@auth<a href="{{ route('dashboard') }}">Open dashboard</a>@else<a href="{{ route('login') }}">Sign in</a><a href="{{ route('register') }}">Create workspace</a>@endauth</div>
                    </div>
                </div>
                <div class="footer-art"><img src="{{ asset('images/marketing/myinboxlab-footer-growth.png') }}" alt="Messages flowing into an organized inbox and moving upward">
                    <div class="footer-tagline">More clarity.<br>More momentum.</div>
                </div>
            </div>
    ...
    <footer class="footer footer-legacy">
        <div class="wrap">
            <div class="footer-top">
                <div class="footer-brand"><a class="brand" href="/"><span class="brand-mark">P</span><span>PERPETUAL</span></a>
                    <p>One clear workspace for every customer conversation—and an AI teammate that keeps things moving.</p>
                </div>
                <div class="footer-links">
                    <div><strong>Product</strong><a href="#product">Unified inbox</a><a href="#ai">AI teammate</a><a href="#how">How it works</a></div>
                    <div><strong>Channels</strong><a href="#product">Instagram</a><a href="#product">WhatsApp</a><a href="#product">Gmail</a></div>
