...
- Next provider-account integrity fix: prevent the same external Gmail identity from being actively connected to different workspaces, while allowing reconnects within its owning workspace and deliberate owner-controlled transfer later.
