...
Route::get('/products/whatsapp', fn () => view('marketing.channel', ['channel' => 'WhatsApp', 'eyebrow' => 'WhatsApp for business', 'headline' => 'Turn conversations into customers.', 'body' => 'Answer questions quickly, share the right details, and keep every customer moving towards a decision.', 'cta' => 'Capture WhatsApp leads →']))->name('marketing.whatsapp');
Route::get('/products/telegram', fn () => view('marketing.channel', ['channel' => 'Telegram', 'eyebrow' => 'Telegram for business', 'headline' => 'Make every message count.', 'body' => 'Bring Telegram enquiries into one clear workspace so your team can respond, qualify, and follow up with confidence.', 'cta' => 'Grow with Telegram →']))->name('marketing.telegram');
Route::get('/products/gmail', fn () => view('marketing.channel', ['channel' => 'Gmail', 'eyebrow' => 'Gmail for business', 'headline' => 'Keep important enquiries moving.', 'body' => 'Organise customer email, surface the conversations that need attention, and help your team follow through.', 'cta' => 'Organise Gmail leads →']))->name('marketing.gmail');
